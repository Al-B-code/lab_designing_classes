...
//        System.out.println("The rectangle has an area of " + area);
        System.out.println("This is the area: " + rectangle.area());
...
//        System.out.println("Object is a square (true/false): " + isRectangle);
    ...
    public static void computerDemo(){
       ...
       Computer computer = new Computer(155);
...
//         computer.setPrinterModel("HPnewModel");
...
//        System.out.println("Computer currently has a " + currentPrinter + " printer connected.");
    ...
    public static void shoppingTrolleyDemo(){
        ...
        System.out.println(trolley.getList());
        ...
        boolean itemInTrolley = trolley.containsItem("Bread");
        System.out.println("Object is present in basket: " + itemInTrolley);
    }
